<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index.html" class="logo logo-dark">
            <span class="logo-sm">
                <img src={{asset('theme/admin/tssets/images/logo-sm.png')}} alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src={{asset('theme/admin/tssets/images/logo-dark.png')}} alt="" height="17">
            </span>
        </a>
        <!-- Light Logo-->
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarCatelogues" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCatelogues">
                        <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Danh muc</span> <span class="badge badge-pill bg-danger" data-key="t-hot">Hot</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarProducts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarProducts">
                        <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Sản phẩm</span> <span class="badge badge-pill bg-danger" data-key="t-hot">Hot</span>
                    </a>
